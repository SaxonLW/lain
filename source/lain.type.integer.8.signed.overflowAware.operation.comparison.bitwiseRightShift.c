...
lain_type_integer_8_signed_overflowAware lain_type_integer_8_signed_overflowAware_operation_comparison_bitwiseRightShift(lain_type_integer_8_signed left, lain_type_integer_8_signed right){
    ...
    switch(rightSign){
        case 1:
            if (right < LAIN_TYPE_INTEGER_8_SIGNED_DEFINE_WIDTH_BIT){
                ret = lain_type_integer_8_signed_overflowAware_operation_construct(lain_type_integer_8_signed_operation_comparison_bitwiseRightShift(left,right), lain_type_integer_8_signed_operation_comparison_bitwiseLeftShift(left, (LAIN_TYPE_INTEGER_8_SIGNED_DEFINE_WIDTH_BIT - right)));
            } else {
        ...
        case 0:
            ...
            break;
        case -1:
            ret = lain_type_integer_8_signed_overflowAware_operation_comparison_bitwiseLeftShift(left, lain_type_integer_8_signed_operation_map_signNegate(right));
            break;
    }
    return ret;
}