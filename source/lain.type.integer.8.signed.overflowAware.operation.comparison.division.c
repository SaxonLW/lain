...
lain_type_integer_8_signed_overflowAware lain_type_integer_8_signed_overflowAware_operation_comparison_division(lain_type_integer_8_signed left, lain_type_integer_8_signed right){
        return lain_type_integer_8_signed_overflowAware_operation_construct(lain_type_integer_8_signed_operation_comparison_division(left,right), (lain_type_integer_8_signed)((right == 0) || ((left == LAIN_TYPE_INTEGER_8_SIGNED_DEFINE_BOUNDRY_LOW) && (right == (lain_type_integer_8_signed)-1))));
}