...
$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.bitwiseAnd.h:$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.typedef.h
ALL_TARGETS+=$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.bitwiseAnd.h

$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.bitwiseLeftShift.h:$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.typedef.h
ALL_TARGETS+=$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.bitwiseLeftShift.h

$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.bitwiseOr.h:$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.typedef.h
ALL_TARGETS+=$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.bitwiseOr.h

$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.bitwiseRightShift.h:$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.typedef.h
ALL_TARGETS+=$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.bitwiseRightShift.h

$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.bitwiseXOr.h:$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.typedef.h
ALL_TARGETS+=$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.bitwiseXOr.h

$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.byPointer.h:$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.byPointer.typedef.h
ALL_TARGETS+=$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.byPointer.h

$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.byPointer.typedef.h:lain.type.integer.8.signed.operation.comparison.pointer.typedef.h lain.type.integer.8.signed.typedef.h lain.type.integer.8.signed.pointer.typedef.h
ALL_TARGETS+=$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.byPointer.typedef.h

$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.byPointer.argument.new.h:lain.type.integer.8.signed.operation.comparison.byThread.argument.new.typedef.h
ALL_TARGETS+=$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.byPointer.argument.new.h

$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.byThread.argument.new.typedef.h:lain.type.integer.8.signed.operation.comparison.byThread.argument.typedef.h lain.type.integer.8.signed.operation.comparison.pointer.typedef.h lain.type.integer.8.signed.pointer.typedef.h
ALL_TARGETS+=$(INCLUDE_DIR)lain.type.integer.8.signed.operation.comparison.byThread.argument.new.typedef.h
